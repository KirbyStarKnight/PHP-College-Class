...
$phpadv = [1 => 'Advanced PHP Techniques', 'Developing Web Applications', 'Advanced Database Concept', 'Basic Object-Oriented Programming'];
...
// Ceate the multidimensional array:
$books = [
	'PHP VQS' => $phpvqs,
