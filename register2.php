...
define('TITLE', 'Register2');
include('templates/header2.html');

// Print some introductory text:
print '<h2>Registration Form</h2>
	<p>Register so that you can take advantage of certian features like this, that, and the other thing.</p>';
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if (!$problem) { // If there weren't any problems...
			...
			// Print a message:
			print '<p class="text--success">You are now registered!<br>Okay, you not really registered but..</p>';
