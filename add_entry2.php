...
if ($_SERVER['REQUEST_METHOD']== 'POST') { // Handle the form.
	...
	// Connect and select:
	$dbc = mysqli_connect('localhost', 'root', 'rachel123', 'myblog');
	...
	if (!$problem) {
		...
		// Define the query:
		$query = "INSERT INTO entries (id, title, entry, data_entered) VALUES (0, '$title', '$entry', NOW())";
		
		// Execute the query:
		if (@mysqli_query($dbc, $query)) {
			print '<p>The blog entry as been added!</p>';
		} else {
